...
<#macro genCode tableInfo>
    ...
    ${fileUtil.setFile(projectPath + "/src/main/java/" + stringUtil.convertStr2Path(groupId) + "/" + stringUtil.convertStr2Path(artifactId) + "/dao/" + capTableName + "DAO.java")}<#t>
/**
 * 系统名称: UF3.0
 * 模块名称: UF3.0 demo
 * 类  名  称: ${capTableName}DAO.java
 * 软件版权: 恒生电子股份有限公司
 * 修改记录:
 * 修改人员                    修改说明 <br>
 * ============  ============================================
 ...
 * ============  ============================================
 */
package ${groupId}.${artifactPackPath}.dao;
 
import ${groupId}.${artifactPackPath}.dao.base.Base${capTableName}DAO;
 ...
 * @date
 */
public interface ${capTableName}DAO extends Base${capTableName}DAO {
